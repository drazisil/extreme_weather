...
public class AdvancedLightingBoltEntity extends LightningBoltEntity {
    private int life;
    private boolean visualOnly;
    private int flashes;
    private ServerPlayerEntity cause;

    public AdvancedLightingBoltEntity(EntityType<? extends LightningBoltEntity> p_i231491_1_, World p_i231491_2_) {
